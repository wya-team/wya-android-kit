...
import com.wya.uikit.advrecyclerview.adapter.SimpleWrapperAdapter;
...
class DraggableItemWrapperAdapter<VH extends RecyclerView.ViewHolder> extends SimpleWrapperAdapter<VH> {
    ...
    /*package*/ void startDraggingItem(DraggingItemInfo draggingItemInfo, RecyclerView.ViewHolder holder, ItemDraggableRange range, int wrappedItemPosition, int itemMoveMode) {
        ...
        mDraggableItemAdapter = WrapperAdapterUtils.INSTANCE.findWrappedAdapter(this, DraggableItemAdapter.class, wrappedItemPosition);
    ...
    boolean canStartDrag(RecyclerView.ViewHolder holder, int position, int x, int y) {
        ...
        final DraggableItemAdapter draggableItemAdapter = WrapperAdapterUtils.INSTANCE.findWrappedAdapter(this, DraggableItemAdapter.class, position);
