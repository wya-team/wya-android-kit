    ...
    private void setClick(int groupPosition, int childPosition) {
        ...
        switch (s) {
            case "抽屉(drawerlayout)":
                startActivity(new Intent(getActivity(), DrawerLayoutExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "drawerlayout" + "/README.md"));
                break;
            case "菜单(optionmenu)":
                startActivity(new Intent(getActivity(), OptionMenuExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "optionmenu" + "/README.md"));
                break;
            case "导航栏(toolbar)":
                startActivity(new Intent(getActivity(), ToolBarExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "toolbar" + "/README.md"));
                break;
            case "分页器(paginationview)":
                startActivity(new Intent(getActivity(), PaginationViewExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "paginationview" + "/README.md"));
                break;
            case "分段控制器(segmentedcontrol)":
                startActivity(new Intent(getActivity(), SegmentedControlExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "segmentedcontrol" + "/README.md"));
                break;
            case "底部导航(tabbar)":
                startActivity(new Intent(getActivity(), TabBarExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "tabbar" + "/README.md"));
                break;
            case "分页控制器(tablayout)":
                startActivity(new Intent(getActivity(), TabLayoutExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "tablayout" + "/README.md"));
                break;
            case "搜索栏(searchBar)":
                startActivity(new Intent(getActivity(), SearchBarExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "searchbar" + "/README.md"));
                break;
            case "气泡(popupwindow)":
            ...
            case "多行输入(customeditext)":
                startActivity(new Intent(getActivity(), CustomEditTextExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "customeditext" + "/README.md"));
                break;
            case "文本输入(customitems(WYAInputItem))":
                startActivity(new Intent(getActivity(), InputItemExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "customitems" + "/README.md"));
                break;
            case "滑动输入条(slidderview)":
                startActivity(new Intent(getActivity(), SlidderViewExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "slidder" + "/README.md"));
                break;
            case "步进器(stepper)":
                startActivity(new Intent(getActivity(), StepperExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "stepper" + "/README.md"));
                break;
            case "软键盘(keyboard)":
                startActivity(new Intent(getActivity(), KeyboardExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "keyboard" + "/README.md"));
                break;
            case "拍照录制视频(camera)":
            ...
            case "卡片(customitems(WYACardView))":
                startActivity(new Intent(getActivity(), CardViewExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "customitems" + "/README.md"));
                break;
            case "轮播图(banner)":
                startActivity(new Intent(getActivity(), BannerExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "banner" + "/README.md"));
                break;
            case "列表(list)":
                startActivity(new Intent(getActivity(), ListExampleActivity.class));
                break;
            case "通告栏(notice)":
                startActivity(new Intent(getActivity(), NoticeExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "notice" + "/README.md"));
                break;
            ...
            case "活动指示器(dialog(WYALoadingDialog))":
                startActivity(new Intent(getActivity(), DialogExampleActivity.class).putExtra("type", 2).putExtra(EXTRA_URL, UIKIT_URL + "dialog" + "/README.md"));
                break;
            case "进度条(progressview)":
                startActivity(new Intent(getActivity(), ProgressExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "progress" + "/README.md"));
                break;
            case "轻提示(toast)":
            ...
            case "视频播放(videoplayer)":
                startActivity(new Intent(getActivity(), VideoPlayerExampleActivity.class).putExtra(EXTRA_URL, HARDWARE_URL + "videoplayer" + "/README.md"));
                break;
            case "清理缓存(utils(DataCleanUtil))":
                startActivity(new Intent(getActivity(), DataCleanExampleActivity.class).putExtra(EXTRA_URL, UTILS_URL));
                break;
            case "数据库基本使用(realm)":
                startActivity(new Intent(getActivity(), RealmExampleActivity.class).putExtra(EXTRA_URL, UIKIT_URL + "realm" + "/README.md"));
                break;
            default:
                break;
