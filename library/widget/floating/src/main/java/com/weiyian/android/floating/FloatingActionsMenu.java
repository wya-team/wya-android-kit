...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonPlusColor = attr.getColor(R.styleable.FloatingActionsMenu_fab_addButtonPlusIconColor, getColor(R.color.customer_home_bg_color));
    ...
    private void createAddButton(final Context context) {
        ...
        mAddButton = new AddFloatingActionButton(context) {
            ...
            Drawable getIconDrawable() {
                ...
                Drawable wrappedDrawable = DrawableCompat.wrap(rotatingDrawable);
                ColorStateList csl = context.getResources().getColorStateList(R.color.selector_color_plus);
                if (null != csl) {
                ...
                final ObjectAnimator expandTextAnimator = ObjectAnimator.ofFloat(mPlusColor, "alpha", 0f, 1f);
                final ObjectAnimator collapseTextAnimator = ObjectAnimator.ofFloat(mPlusColor, "alpha", 1f, 0f);
                
                collapseAnimator.setInterpolator(interpolator);
                expandTextAnimator.setInterpolator(interpolator);
                expandAnimator.setInterpolator(interpolator);
                collapseTextAnimator.setInterpolator(interpolator);
                
                mExpandAnimation.play(expandAnimator).with(expandTextAnimator);
                mCollapseAnimation.play(collapseAnimator).with(collapseTextAnimator);
    ...
    public void toggle() {
        ...
        mAddButton.setSelected(mExpanded);
    }
