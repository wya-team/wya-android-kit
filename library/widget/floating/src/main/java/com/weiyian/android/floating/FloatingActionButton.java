...
public class FloatingActionButton extends AppCompatTextView {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int p_w_picpathResId, int textResId) {
        super(context, attrs);
    }
    ...
    private StateListDrawable createFillDrawable(float strokeWidth) {
        ...
        drawable.addState(new int[]{android.R.attr.state_selected}, createCircleDrawable(mColorPressed, strokeWidth));
