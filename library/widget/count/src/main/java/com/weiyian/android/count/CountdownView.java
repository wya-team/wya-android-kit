package com.weiyian.android.count;
...
public class CountdownView extends View {
    ...
    private BaseCountDownTimer mCustomCountDownTimer;
    ...
    public void start(long millisecond) {
        ...
        mCustomCountDownTimer = new BaseCountDownTimer(millisecond, countDownInterval) {
            @Override
