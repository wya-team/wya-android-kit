...
import com.weiyian.android.xpopup.animator.ScaleAlphaAnimator;
import com.weiyian.android.xpopup.animator.ScrollScaleAnimator;
import com.weiyian.android.xpopup.animator.ShadowBgAnimator;
import com.weiyian.android.xpopup.animator.TranslateAlphaAnimator;
import com.weiyian.android.xpopup.animator.TranslateAnimator;
import com.weiyian.android.xpopup.enums.PopupStatus;
import com.weiyian.android.xpopup.interfaces.PopupInterface;
...
public abstract class BasePopupView extends FrameLayout implements PopupInterface {
    ...
    protected BasePopupAnimator popupContentAnimator;
    ...
    public void init(Runnable afterShow, Runnable afterDismiss) {
        if (null == popupInfo || popupStatus != PopupStatus.Dismiss) {
            return;
        }
     ...
     */
    protected BasePopupAnimator genAnimatorByPopupType() {
    ...
    public void doShowAnimation() {
        if (null != popupInfo && popupInfo.hasShadowBg) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (distance < touchSlop && (System.currentTimeMillis() - downTime) < 350) {
                        if (null != popupInfo && popupInfo.isDismissOnTouchOutside) {
                            dismiss();
                        }
                    }
                    x = 0;
