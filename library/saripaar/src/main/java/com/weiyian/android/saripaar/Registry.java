...
import com.weiyian.android.saripaar.adapter.text.TextViewDoubleAdapter;
import com.weiyian.android.saripaar.adapter.text.TextViewFloatAdapter;
import com.weiyian.android.saripaar.adapter.text.TextViewIntegerAdapter;
import com.weiyian.android.saripaar.adapter.text.TextViewStringAdapter;
import com.weiyian.android.saripaar.adapter.ViewDataAdapter;
import com.weiyian.android.saripaar.annotation.ValidateUsing;
import com.weiyian.android.saripaar.exception.SaripaarViolationException;
 ...
 * {@link com.weiyian.android.saripaar.adapter.ViewDataAdapter}s that are registered to rule
 * Annotations.
 *
...
final class Registry {
    ...
    private static final Map<Class<? extends View>, HashMap<Class<?>, ViewDataAdapter>> STOCK_ADAPTERS = new HashMap<Class<? extends View>, HashMap<Class<?>, ViewDataAdapter>>();
    // Attributes
    private Map<Class<? extends Annotation>, HashMap<Class<? extends View>, ViewDataAdapter>> mMappings;
    ...
    /**
     * Registers {@link com.weiyian.android.saripaar.adapter.ViewDataAdapter}s for the associated
     ...
     * @param viewDataAdapter The {@link com.weiyian.android.saripaar.adapter.ViewDataAdapter}
     ...
     *                        {@link com.weiyian.android.saripaar.adapter.ViewDataAdapter}.
     ...
     *                        is returned by the {@link com.weiyian.android.saripaar.adapter.ViewDataAdapter}.
     */
    ...
    /**
     * Retrieves the registered {@link com.weiyian.android.saripaar.adapter.ViewDataAdapter} associated
     ...
     *                       the {@link com.weiyian.android.saripaar.adapter.ViewDataAdapter}.
     * @return Registered or compatible
     * {@link com.weiyian.android.saripaar.adapter.ViewDataAdapter} or null if none is
     * found.
     */
    @SuppressWarnings("unchecked")
    <VIEW extends View> ViewDataAdapter<VIEW, ?> getDataAdapter(final Class<? extends Annotation> annotationType, final Class<VIEW> viewType) {
        
        HashMap<Class<? extends View>, ViewDataAdapter> viewDataAdapterHashMap = mMappings.get(annotationType);
        ...
        if (viewDataAdapterHashMap != null) {
            ...
            if (matchingViewAdapter == null) {
                matchingViewAdapter = getCompatibleViewDataAdapter(viewDataAdapterHashMap, viewType);
            }
        }
    ...
    private void assertAttribute(final Class<? extends Annotation> annotationType, final String attributeName, final Class<?> attributeType) {
    ...
    private <DATA_TYPE, VIEW extends View> void assertCompatibleReturnType(final Class<DATA_TYPE> ruleDataType, final ViewDataAdapter<VIEW, DATA_TYPE> viewDataAdapter) {
    ...
    private <VIEW extends View> ViewDataAdapter getCompatibleViewDataAdapter(final HashMap<Class<? extends View>, ViewDataAdapter> viewDataAdapterHashMap, final Class<VIEW> viewType) {
