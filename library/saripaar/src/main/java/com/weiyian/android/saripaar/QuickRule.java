...
/**
 * Unlike {@link com.weiyian.android.saripaar.AnnotationRule}s,
 * {@link com.weiyian.android.saripaar.QuickRule}s can exist without Annotations. These rules are
 * directly applied to {@link android.view.View}s. They are added to the
 * {@link com.weiyian.android.saripaar.Validator} using the
 * {@link com.weiyian.android.saripaar.Validator#put(android.view.View, QuickRule[])} method.
 *
