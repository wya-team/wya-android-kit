...
class RegisterExtension {
     ...
     */
    static final String GENERATE_TO_CLASS_NAME = 'com/weiyian/android/router/core/LogisticsCenter'
    /**
     ...
     */
    static final String ROUTER_CLASS_PACKAGE_NAME = 'com/weiyian/android/router/routes/'
    /**
     * The package name of the interfaces
     */
    private static final INTERFACE_PACKAGE_NAME = 'com/weiyian/android/router/facade/template/'
     ...
     */
    RegisterExtension(String interfaceName) {
