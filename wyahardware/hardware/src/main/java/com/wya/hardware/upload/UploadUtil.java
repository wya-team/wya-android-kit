...
public class UploadUtil {
    ...
    public static void upload(Context context, PostBeforeInterface before, String fileName, String filePath) {
        ...
        updload(context, ossInfo, fileName, filePath);
    }
    
    public static void updload(Context context, OssInfo ossInfo, String fileName, String filePath) {
        if (null == ossInfo) {
            return;
        }
        updload(context, ossInfo, fileName, filePath, (status, msg, data) -> Log.e("TAG", "[onPostAfter] status = " + status + " , msg = " + msg + " , data = " + data));
    }
    
    public static void updload(Context context, OssInfo ossInfo, String fileName, String filePath, PostAfterInterface postAfter) {
        if (null == ossInfo) {
            return;
        }
