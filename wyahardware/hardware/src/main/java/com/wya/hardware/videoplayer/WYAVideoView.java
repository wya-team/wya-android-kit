...
import com.wya.hardware.videoplayer.listener.SimplePlayerCallback;
import com.wya.hardware.videoplayer.view.VideoBehaviorView;
    ...
    private void initPlayer() {
        ...
        mMediaPlayer.setCallback(new SimplePlayerCallback() {
            ...
            public void onStateChanged(int curState) {
                switch (curState) {
                    case WYAVideoPlayer.STATE_IDLE:
